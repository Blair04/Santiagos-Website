  ...
  factory FurnitureCategory.fromMap(Map<String, dynamic> map) {
    return FurnitureCategory(
      ...
      products: map['FURNITURE'] != null
          ? (map['FURNITURE'] as List)
              .map((p) => FurnitureProduct.fromMap(p))
              .toList()
          : const [],
    );
  }
    ...
    try {
      ...
      setState(() {
        _categories = (data as List)
            .map((e) => FurnitureCategory.fromMap(e))
            .toList();
      });
    } catch (e) {
      _showSnackBar(
...
const SizedBox(height: 15),
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Text(
              '${_filtered.length} '
              '${_filtered.length == 1 ? 'category' : 'categories'}',
              ...
              children: [
                ...
                Container(
                  ...
                  child: category.products.isEmpty
                      ? const Text(
                          'No furniture products registered.',
                          style: TextStyle(
                            color: _textMuted,
                            fontSize: 13,
  ...
  void _showSnackBar(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(msg),
        backgroundColor:
            isError ? Colors.redAccent : _brown,
